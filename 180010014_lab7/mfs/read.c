...
int fs_readwrite(void)
{
  ...
  if(immediate==1) {
    if(rw_flag==READING) {
      printf("Minix 3: Reading from an Immediate file\n");
      ...
      printf("Minix 3: This are contents of Immediate Files:\n");
      for(i=0; i<f_size; ++i) {
        printf("%c", buffer[i]);
      }
      printf("Minix 3: EOF (Immediate File)\n");
      ...
      printf("Minix 3: Writing to an Immediate file\n");
      vir_bytes zone;
